...
| 文件 | 内容 |
|------|------|
| `dist/universal-browser-0.1.2.zip` | **标准 Skill**：仅 `SKILL.md` + `references/` |
| `dist/universal-browser-full-0.1.2.zip` | **完整包**：+ `templates/` + `runtime/` + `scripts/`（独立 Windows 模式） |
...
```text
dist/universal-browser-0.1.2.zip
  └── universal-browser/
        ├── SKILL.md
        └── references/
```
...
```text
dist/universal-browser-full-0.1.2.zip
  └── universal-browser/
        ├── SKILL.md
        ├── references/
        ├── templates/
